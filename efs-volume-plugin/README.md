EFS Mounted Volume Plugin
=========================

This is a managed Docker volume plugin to allow Docker containers to access an AWS EFS mount without installing NFS on the host.  This is basically the NFS plugin but the configuration is simplified for AWS EFS
